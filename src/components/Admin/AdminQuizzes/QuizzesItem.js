...
import { useDeleteQuizMutation } from '../../../features/quizzes/quiezzesApi';
import Modal from '../../UI/Modal/Modal';
import AdminQuizUpdateForm from '../Forms/AdminQuizUpdateForm';
...
export default function QuizzesItem({ quiz }) {
  ...
  return (
    <>
      ...
      {/* Edit Modal */}
      {openModal && (
        <Modal setOpenModal={setOpenModal} title={'Edit Quiz'}>
          <AdminQuizUpdateForm quizId={id} setOpenModal={setOpenModal} />
        </Modal>
      )}
    </>
  );
